...
class ExbotMod(loader.Module):
  ...
  @loader.on_bot(self, app, message.text[:4] == "/dnl")
  ...
  @loader.on_bot(self, app, message.text[:4] == "/ben")
  ...
  @loader.on_bot(self, app, message.text[:7] == "/random")
  ...
  @loader.on_bot(self, app, message.text[:8] == "/randint")
